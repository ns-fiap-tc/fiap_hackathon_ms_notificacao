# FIAP Hackathon - Microsserviço de notificação
Repositório com o microsserviço de notificacao para o hackathon

Este é o repositório que contém o código fonte do serviço de notificacao da aplicação [FIAP Hackathon](https://github.com/ns-fiap-tc/fiap_hackathon_doc). Nele você também encontrará arquivos de configuração do Terraform que fazem o deploy da aplicação na AWS.
...
> 4. A provisão deste repositório: [fiap_hackathon_ms_notificacao](#como-rodar-o-projeto);
...
#### 📖 Resumo
Este repositório possui uma pipeline automatizada chamada `Terraform Deploy` que permite **provisionar a infraestrutura do serviço de notificação** sempre que houver um push na branch `main`.
...
```bash
git clone https://github.com/ns-fiap-tc/fiap_hackathon_ms_notificacao
```

2. **Acesse o diretório do repositório clonado, por exemplo**:

```bash
cd fiap_hackathon_ms_notificacao
```
...
<img width="1852" height="537" alt="Captura de tela de 2025-09-28 19-02-28" src="https://github.com/user-attachments/assets/5096dfad-17c5-461d-abf5-d0f72844ea9c" />
